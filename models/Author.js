...
// SELECT authors_articles.article_id, authors.name FROM authors_articles JOIN users ON authors.id = authors_articles.author_id AND authors_articles.article_id = 2;
